...
$style = "";
if( $bg_pos != '' ) {
    $style .= esc_attr( "background-position: {$bg_pos} !important;" ) ;
}
if( $bg_attachment != '' ) {
    $style .= esc_attr( "background-attachment: {$bg_attachment} !important;" ) ;
}
if ( $style != '' )
...
if ( ! empty( $parallax ) ) {
	...
	$wrapper_attributes[] = 'data-vc-parallax="2"'; // parallax speed
...
if ( $bg_color_preset ) $css_class .= ' ' . $bg_color_preset;
